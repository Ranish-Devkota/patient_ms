...
<?php
    if(isset($_POST['submit'])){ //check if form was submitted
        ...
        if($department_name){
            $con->query("UPDATE departments SET name = '$department_name' WHERE departments.id = '$id'");
            // echo $department_name." updated inserted successfully!!";
            ...
            <div class="card-body">
                <div class="p-5">
                    <div class="text-center mb-4">
                        <h1 class="h4 text-gray-900">Update Departments</h1>
                        <?php 
                            if($empty_field){
                        ...
                        <div class="form-group row">
                            <div class="col-sm-4 mb-3 mb-sm-0">
                                <input type="text" class="form-control form-control-user" id="name" name="name"
                                    placeholder="Department Name" value="<?php echo $depart->name ?>">
                            </div>
                        </div>
